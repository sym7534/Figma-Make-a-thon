import svgPaths from "./svg-2uqd4d781q";
...
function Paragraph() {
  return (
    <div className="absolute h-[27px] left-[57px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.8)] top-[638px] w-[183.1px]" data-name="Paragraph">
      <p className="absolute font-['LoRes_9_OT:Wide_Regular',sans-serif] leading-[27px] left-[120.5px] not-italic text-[18px] text-center text-nowrap text-white top-0 translate-x-[-50%] whitespace-pre">Select your residence..</p>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="absolute contents left-[33px] top-[622px]" data-name="Dropdown">
      <div className="absolute backdrop-blur-[15px] backdrop-filter bg-gradient-to-r from-[rgba(227,227,227,0.45)] h-[60px] left-[33px] rounded-[40px] to-[rgba(241,241,241,0.45)] top-[622px] w-[342px]">
      ...
      <div className="absolute flex items-center justify-center left-[335px] size-[20px] top-[642px]">
...
export default function MainMenuDoorOpen() {
  return (
    <div className="relative size-full" data-name="Main Menu Door Open" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\\'0 0 402 874\\\' xmlns=\\\'http://www.w3.org/2000/svg\\\' preserveAspectRatio=\\\'none\\\'><rect x=\\\'0\\\' y=\\\'0\\\' height=\\\'100%\\\' width=\\\'100%\\\' fill=\\\'url(%23grad)\\\' opacity=\\\'1\\\'/><defs><radialGradient id=\\\'grad\\\' gradientUnits=\\\'userSpaceOnUse\\\' cx=\\\'0\\\' cy=\\\'0\\\' r=\\\'10\\\' gradientTransform=\\\'matrix(1.2308e-15 43.7 -20.1 2.6759e-15 201 437)\\\'><stop stop-color=\\\'rgba(68,72,83,1)\\\' offset=\\\'0\\\'/><stop stop-color=\\\'rgba(42,44,50,1)\\\' offset=\\\'0.48317\\\'/><stop stop-color=\\\'rgba(29,30,33,1)\\\' offset=\\\'0.72476\\\'/><stop stop-color=\\\'rgba(16,16,16,1)\\\' offset=\\\'0.96635\\\'/></radialGradient></defs></svg>')" }}>
      ...
      <Dropdown />
      <div className="absolute h-[397px] left-[2px] top-[210px] w-[363px]" data-name="OPEN DOOR">
