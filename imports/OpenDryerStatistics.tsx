import svgPaths from "./svg-hv5wa1eiyb";
...
import imgAdobeExpressFile4 from "figma:asset/23448f3e85b10c67a7896d1c5e8cb04a1baa9828.png";
...
export default function OpenDryerStatistics({ onBack }: { onBack?: () => void }) {
  return (
    <div className="bg-[#fefefe] relative size-full" data-name="Open Dryer Statistics">
      ...
      <div className="absolute left-[22px] size-[351px] top-[99px]" data-name="Adobe Express - file 4">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgAdobeExpressFile4} />
      </div>
      ...
      <div className="[text-shadow:rgba(0,0,0,0.1)_0px_4px_4px] absolute font-['LoRes_9_OT:Wide_Regular',sans-serif] leading-[normal] left-[165px] not-italic text-[18px] text-black text-nowrap top-[55px] whitespace-pre">
        <p className="mb-0">Dryer 2</p>
        <p>&nbsp;</p>
      </div>
      <p className="absolute font-['LoRes_9_OT:Wide_Regular',sans-serif] leading-[normal] left-[calc(50%-199px)] not-italic text-[15px] text-black text-nowrap top-[747px] whitespace-pre">Dryer recently reported to have: odours, lint</p>
      ...
      <div className="absolute backdrop-blur-[15px] backdrop-filter bg-[#c4efc9] h-[75px] left-[16px] rounded-[40px] top-[439px] w-[370px] cursor-pointer transition-all duration-200 hover:bg-[#a8e0b0]" data-name="Rounded rectangle">
      ...
      <p className="absolute font-['LoRes_9_OT:Wide_Regular',sans-serif] leading-[normal] left-[calc(50%-67px)] not-italic text-[15px] text-black text-nowrap top-[466px] whitespace-pre pointer-events-none">CLAIM MACHINE</p>
